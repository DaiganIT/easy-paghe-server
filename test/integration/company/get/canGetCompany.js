...
//     expect(company.bases[0].hirees).to.not.be.ok;
//     expect(company.bases[1].hirees).to.not.be.ok;
//   });
// });
...
//     expect(company.bases[1].name).to.equal('Additional Base');
//     expect(company.bases[1].address).to.equal('The additional address');
//     expect(company.bases[0].hirees).to.have.lengthOf(2);
//     expect(company.bases[1].hirees).to.have.lengthOf(1);
//   });
// });
...
describe('GIVEN I have a company DTO', function () {
  ...
  before('WHEN I use get a company', async () => {
    company = await companySteps.whenIGetCompanyAsync(1, false);
  });
...
describe('GIVEN I have a company DTO', function () {
  ...
  it('THEN Company is returned', function () {
    ...
    expect(company.bases[1].name).to.equal('Additional Base');
    expect(company.bases[1].address).to.equal('The additional address');
    expect(company.bases[0].hirees).to.have.lengthOf(0);
    expect(company.bases[1].hirees).to.have.lengthOf(0);
  });
});
